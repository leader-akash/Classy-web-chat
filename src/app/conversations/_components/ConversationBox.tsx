...
const ConversationBox: React.FC<ConversationBoxProps> = ({
  ...
  // it will check currently logged in user
  ...
  const hasSeen = useMemo(() => {
    ...
    return seenArray?.filter((user) => user?.phoneNumber === userPhoneNumber)
  ...
  return (
    <div>
      <div
        onClick={handleClick}
        className={clsx(
          `relative flex items-center space-x-3 p-3 hover:bg-neutral-100 transition cursor-pointer`,
